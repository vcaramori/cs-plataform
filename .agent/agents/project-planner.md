...
# P0: Security Scan
python docs/skills/vulnerability-scanner/scripts/security_scan.py .

# P1: UX Audit
python docs/skills/frontend-design/scripts/ux_audit.py .

# P3: Lighthouse (requires running server)
python docs/skills/performance-profiling/scripts/lighthouse_audit.py http://localhost:3000

# P4: Playwright E2E (requires running server)
python docs/skills/webapp-testing/scripts/playwright_runner.py http://localhost:3000 --screenshot
```
