...
## Epic 11: Governan�a Comercial Centralizada (Desacoplada)
### Story 11.1: Entidade Governan�a
Como CSM, quero gerenciar descontos e multas de forma independente dos contratos para maior flexibilidade comercial.
### Story 11.2: Regras Globais vs Espec�ficas
Como CSM, quero poder aplicar uma regra de governan�a a toda a conta ou a um contrato espec�fico.
