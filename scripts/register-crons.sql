...
SELECT cron.unschedule('cron-adoption-analysis');
...
SELECT cron.unschedule('cron-alert-analysis');
...
SELECT cron.unschedule('cron-analyze-ticket-sentiments');
...
SELECT cron.unschedule('cron-auto-assign-tickets');
...
SELECT cron.unschedule('cron-auto-checkin-generate');
...
SELECT cron.unschedule('cron-auto-checkin-send');
...
SELECT cron.unschedule('cron-cs-ops-daily');
...
SELECT cron.unschedule('cron-escalate-sla-violations');
...
SELECT cron.unschedule('cron-health-score-daily');
...
SELECT cron.unschedule('cron-proactive-alerts');
