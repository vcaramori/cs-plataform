    ...
    return (
      <div className="bg-slate-900 border border-white/10 p-3 rounded-xl shadow-2xl">
        ...
        <div className="flex items-center gap-2">
           ...
           <p className="text-sm font-bold text-white">{payload[0].value} <span className="text-[9px] text-slate-500 font-bold uppercase ml-1">Usuários Ativos</span></p>
        </div>
      </div>
    );
  }
  ...
  if (metrics.length === 0) {
    return (
      <Card className="bg-slate-900/40 border-slate-800 border-dashed p-10 text-center">
        <p className="text-slate-600 text-[10px] font-bold uppercase tracking-widest">Aguardando dados de telemetria</p>
      </Card>
    )
  }
    ...
    >
      ...
      <div className="flex items-center justify-between mb-8">
        <div className="space-y-1">
          <h3 className="text-white text-[11px] font-heading font-extrabold uppercase tracking-[0.15em] flex items-center gap-2">
             Volume de Uso
          </h3>
          <p className="text-slate-500 text-[9px] font-bold uppercase tracking-tighter">Telemetria MAU Mensal</p>
        </div>
      ...
      <div className="mt-6 flex items-center justify-center gap-6">
        <div className="flex items-center gap-2">
           ...
           <span className="text-[10px] text-slate-500 font-bold uppercase tracking-widest">Adoção Estável</span>
        </div>
      </div>
    </motion.div>
  )
