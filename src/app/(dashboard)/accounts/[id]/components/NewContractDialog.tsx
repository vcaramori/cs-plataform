        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 px-6 py-6 overflow-y-auto max-h-[70vh]">
          <div className="grid grid-cols-2 gap-4">
            <div className="space-y-2">
              <Label className="text-[10px] font-black text-content-secondary dark:text-content-secondary uppercase tracking-widest ml-1">Tipo de Registro</Label>
              <SearchableSelect
            ...
            <div className="space-y-2">
              <Label className="text-[10px] font-black text-content-secondary dark:text-content-secondary uppercase tracking-widest ml-1">Plano de Serviço</Label>
              <SearchableSelect
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label className="text-[10px] font-black text-content-secondary dark:text-content-secondary uppercase tracking-widest ml-1">MRR (R$)</Label>
              <Input {...register('mrr')} type="number" step="0.01" className="h-11 rounded-xl bg-white dark:bg-slate-900 border border-border-divider dark:border-slate-800 text-[#2d3558] dark:text-white shadow-sm focus-visible:ring-plannera-orange" />
              {errors.mrr && <p className="text-destructive text-[10px] font-bold ml-1">{errors.mrr.message}</p>}
            </div>
            <div className="space-y-2">
              <Label className="text-[10px] font-black text-content-secondary dark:text-content-secondary uppercase tracking-widest ml-1">Horas Contratadas/Mês</Label>
              <Input {...register('contracted_hours_monthly')} type="number" step="0.5" className="h-11 rounded-xl bg-white dark:bg-slate-900 border border-border-divider dark:border-slate-800 text-[#2d3558] dark:text-white shadow-sm focus-visible:ring-plannera-orange" />
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label className="text-[10px] font-black text-content-secondary dark:text-content-secondary uppercase tracking-widest ml-1">Data de Início</Label>
              <Input {...register('start_date')} type="date" className="h-11 rounded-xl bg-white dark:bg-slate-900 border border-border-divider dark:border-slate-800 text-[#2d3558] dark:text-white shadow-sm focus-visible:ring-plannera-orange" />
              {errors.start_date && <p className="text-destructive text-[10px] font-bold ml-1">{errors.start_date.message}</p>}
            </div>
            <div className="space-y-2">
              <Label className="text-[10px] font-black text-content-secondary dark:text-content-secondary uppercase tracking-widest ml-1">Data de Renovação</Label>
              <Input {...register('renewal_date')} type="date" className="h-11 rounded-xl bg-white dark:bg-slate-900 border border-border-divider dark:border-slate-800 text-[#2d3558] dark:text-white shadow-sm focus-visible:ring-plannera-orange" />
              {errors.renewal_date && <p className="text-destructive text-[10px] font-bold ml-1">{errors.renewal_date.message}</p>}
            </div>
          </div>

          <div className="space-y-2">
            <Label className="text-[10px] font-black text-content-secondary dark:text-content-secondary uppercase tracking-widest ml-1">Produto / Descrição</Label>
            <Input {...register('description')} placeholder="Ex: S&OP, S&OE, Abast..." className="h-11 rounded-xl bg-white dark:bg-slate-900 border border-border-divider dark:border-slate-800 text-[#2d3558] dark:text-white shadow-sm focus-visible:ring-plannera-orange" />
            {errors.description && <p className="text-destructive text-[10px] font-bold ml-1">{errors.description.message}</p>}
          </div>

          <div className="space-y-2">
            <Label className="text-[10px] font-black text-content-secondary dark:text-content-secondary uppercase tracking-widest ml-1">Notas do Aditivo</Label>
            <Textarea {...register('notes')} placeholder="Detalhes adicionais..." className="min-h-[100px] bg-surface-background dark:bg-slate-800/50 border border-border-divider dark:border-slate-800 rounded-xl shadow-inner text-sm text-[#2d3558] dark:text-white focus-visible:ring-plannera-orange" />
