...
export function AtividadesKanbanView({ tasks, onEdit, onStatusChange, onDelete }: Props) {
  ...
  return (
    // Grid: 4 colunas de largura igual, sem limite de altura — cada raia cresce com o conteúdo
    // e todas ficam com o mesmo height via CSS Grid (align-items: stretch por padrão)
