  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Playbook Builder</h1>
          <p className="text-slate-600 mt-2">Canvas para criar playbooks automatizados sem código</p>
        </div>

        <div className="grid grid-cols-4 gap-4">
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4">
            <h3 className="font-medium text-slate-900 mb-3">Actions</h3>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-slate-200 p-4">
            <h3 className="font-medium text-slate-900 mb-3">Conditions</h3>
            <div className="space-y-2">
        ...
        <div className="flex justify-end gap-2">
          <button className="px-4 py-2 rounded border border-slate-300 hover:bg-slate-50 font-medium">Cancelar</button>
