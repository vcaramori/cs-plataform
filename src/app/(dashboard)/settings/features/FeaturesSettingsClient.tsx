    ...
    <PageContainer className="max-w-[1400px] space-y-10">
      <div className="flex flex-col gap-2 relative">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="h1-page">Configuracao de Funcionalidades</h1>
        </div>
        <p className="label-premium">
          Estrutura Dinamica de Modulos e Valor do Produto (Admin)
        </p>
      </div>

      <div className="space-y-6">
        <SectionHeader
          title="Catalogo de Funcionalidades"
          subtitle="Unidades logicas do sistema que compoem os planos"
          ...
          <AnimatePresence mode="popLayout">
            {loading ? (
              ...
              <div className="col-span-full py-20 text-center bg-surface-card border border-border-divider rounded-2xl">
                <p className="text-content-secondary text-[10px] font-extrabold uppercase tracking-widest opacity-60">Nenhuma funcionalidade cadastrada.</p>
              </div>
            ) : (
                  ...
                  <Card className="shadow-xl hover:opacity-90 transition-all group overflow-hidden h-full">
                    ...
                    <CardContent className="pt-4 space-y-4">
                      <p className="label-premium !text-[10px] opacity-60 min-h-[40px]">
                        {feature.description || 'Nenhuma descricao tecnica informada.'}
                      </p>
