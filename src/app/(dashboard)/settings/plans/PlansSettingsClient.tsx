...
export function PlansSettingsClient() {
    ...
    <PageContainer className="max-w-[1400px] space-y-10">
      <div className="flex flex-col gap-2 relative">
        ...
        <div className="flex items-center gap-3">
          ...
          <h1 className="h1-page">Configuracao de Planos</h1>
        </div>
        <p className="label-premium">Estrutura de Ofertas e Composicoes Contratuais (Admin)</p>
      </div>

      <div className="space-y-6">
        <SectionHeader
          title="Estrutura de Planos"
          subtitle="Composicao de ofertas para o mercado"
                    ...
                    <CardContent className="pt-4 flex-1 flex flex-col justify-between">
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge className="bg-plannera-sop/20 text-plannera-sop border-none text-[9px] font-bold">{plan.plan_features?.length || 0} Itens</Badge>
                        </div>
