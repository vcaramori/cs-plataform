        ...
        <div className="bg-white dark:bg-slate-900 border border-border-divider rounded-2xl shadow-xl p-8 space-y-5">
          {success ? (
            <div className="text-center space-y-4">
              ...
              <h2 className="text-foreground text-lg font-black uppercase tracking-tight">Senha Atualizada</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                disabled={loading}
                className="w-full h-11 rounded-xl bg-plannera-orange hover:bg-plannera-orange/90 text-white font-black uppercase tracking-widest text-xs gap-2 mt-2"
              >
