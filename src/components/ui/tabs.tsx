...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-11 items-center justify-start rounded-xl bg-surface-card p-1 text-content-secondary border border-border-divider',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      'data-[state=active]:bg-white dark:data-[state=active]:bg-slate-800 data-[state=active]:text-content-primary data-[state=active]:shadow-sm',
      className,
    )}
    {...props}
  />
